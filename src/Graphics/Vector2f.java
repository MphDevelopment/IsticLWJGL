package Graphics;
/*
#define SCALAIRE2(v1, v2) v1.x*v2.x + v1.y*v2.y
#define SCALAIRE3(v1, v2) v1.x*v2.x + v1.y*v2.y + v1.z*v2.z
#define PRODUCT3(v1, v2) sf::Vector3f((v1.y * v2.z) - (v1.z * v2.y), (v1.z * v2.x) - (v1.x * v2.z), (v1.x * v2.y) - (v1.y * v2.x))
*/
